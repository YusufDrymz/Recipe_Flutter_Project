...
class DetailReciperScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<String> ingredients = ['4 Yumurta', '1/2 Tereyağı', '1 Litre Su'];
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 8),
                              Text("273 Beğeni", style: TextTypography.mH3)
                            ],
                          )
                        ],
                      ),
                      ...
                      Text('Açıklama', style: TextTypography.mH3),
                      Container(
                        padding: EdgeInsets.only(top: 8, bottom: 16),
                        child: Text(
                          "Tarifiniz yüklendi, profilinizde görebilirsiniz. Tarifiniz yüklendi, sayfanızda görebilirsiniz.",
                      ...
                      Container(
                        ...
                        child: Text('İçindekiler', style: TextTypography.mH3),
                      ),
                      Expanded(
                        child: Container(
                      ...
                      Container(
                        padding: EdgeInsets.symmetric(vertical: 16),
                        child: Text('Adımlar', style: TextTypography.mH3),
                      ),
                      Expanded(
                        flex: 2,
                        child: Container(
