      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Text('Yusuf Erkan Darıyemez', style: TextTypography.mH2),
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              countCategory(count: '32', label: 'Tarif'),
              countCategory(count: '782', label: 'Takip Etme'),
              countCategory(count: '1.287', label: 'Takipçiler'),
            ],
          ),
          // Container(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: TabBar(
                      ...
                      tabs: <Widget>[Tab(text: "Tarifler"), Tab(text: "Beğeniler")],
                    ),
                  ),
                  Expanded(
                    child: Container(
